...
export const montagnana_sugia_params: KellyParams = {
  ...
  cornerR: 133,
  cornerGuideLowY: 160,
  cornerGuideLowXOff: 24,
  cornerGuideUpY: 589,
  cornerGuideUpXOff: -20,
...
export const Strad_Davidoff_Params: KellyParams = {
  ...
  cornerR: 141,
  cornerGuideLowY: 179,
  cornerGuideLowXOff: 48,
  cornerGuideUpY: 588,
  cornerGuideUpXOff: 0,
  cornerCircUpBoutR: 52,
  cornerCircUpCBoutR: 26,
  cornerCircLowCBoutR: 52,
  cornerCircLowBoutR: 52,
  blockCornerUpH: 30,
  blockCornerUpW: 30,
  blockCornerUpPad: 8,
  blockCornerLowH: 30,
  ...
  blockUpW: 60,
  clampChannelWidth: 22,
  cornerCircDubLowCBoutR: 13,
  cornerCircDubLowCBoutTheta: 270,
  cornerCircDubLowBoutR: 42,
  cornerCircDubLowBoutTheta: 180,
  cornerCircleDubLowCBoutTheta: 310,
  cornerCircleDubLowBoutTheta: 155,
  cornerCircDubUpBoutR: 48,
  cornerCircDubUpBoutTheta: 180,
  cornerCircDubUpCBoutR: 22,
  cornerCircDubUpCBoutTheta: 110,
  cornerCircDubUpBoutCutoffTheta: 210,
  cornerCircleDubUpCBoutCutoffTheta: 60,
}

export const Ravatin_Mans_Params: KellyParams = {
  height: 758.8,
  width: 457.4,
  inset: 6.7,
  bitDiameter: 6.35,
  ...
  cornerR: 129,
  cornerGuideLowY: 127,
  cornerGuideLowXOff: 39,
  cornerGuideUpY: 608,
  cornerGuideUpXOff: 0,
  cornerCircUpBoutR: 53,
  cornerCircUpCBoutR: 26,
  cornerCircLowCBoutR: 37,
  cornerCircLowBoutR: 45,
  blockCornerUpH: 40,
  blockCornerUpW: 26,
  blockCornerUpPad: 8,
  blockCornerLowH: 40,
  ...
  blockUpH: 40,
  blockUpW: 70,
  clampChannelWidth: 30,
  cornerCircDubLowCBoutR: 38,
  cornerCircDubLowCBoutTheta: 270,
  cornerCircDubLowBoutR: 43,
  cornerCircDubLowBoutTheta: 180,
  cornerCircleDubLowCBoutTheta: 295,
  cornerCircleDubLowBoutTheta: 150,
  cornerCircDubUpBoutR: 45,
  cornerCircDubUpBoutTheta: 180,
  cornerCircDubUpCBoutR: 19,
  cornerCircDubUpCBoutTheta: 85,
  cornerCircDubUpBoutCutoffTheta: 205,
  cornerCircleDubUpCBoutCutoffTheta: 60,
}
...
export const KELLY_TEMPLATES: KellyTemplate[] = [
	...
	},
	{
		...
		description: '',
		...new KellyViolinRecipe('Ravatin - Mans', Ravatin_Mans_Params),
		referenceImage: {
